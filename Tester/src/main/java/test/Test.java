...
import pt.tecnico.graph.job.EdgeAddDeleteStreamJob;
...
public class Test {
    public static void main(String[] args) {
        //ExecutionEnvironment env = ExecutionEnvironment.createRemoteEnvironment("localhost", 6123, "flink-graph-algorithms-0.1.jar");
...
/*
        ...
        EdgeStreamApproxJob<Integer> graphJob = new EdgeStreamApproxJob<>(new Configuration(1000, 3));
        ...
        */
        ...
        //EdgeStreamApproxJob<Integer, NullValue, Double> graphJob = new EdgeStreamApproxJob<>(new Configuration(1000, 50));
        EdgeAddDeleteStreamJob<Integer, Double> graphJob = new EdgeAddDeleteStreamJob<>(new Configuration(10000, 2000));
        graphJob.setGraph(initialGraph);
